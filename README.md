...
- recipes are in a skill folder with more customization and specific guidelines on using the skill based on use-cases. Typically put in skill/recipes/YOUR_RECIPE.md.
